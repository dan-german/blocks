...
#include "vital/synthesis/modules/formant_module.h"
...
class FilterProcessor: public SynthModule {
public:
  enum {
    kAudio,
    kReset,
  ...
  virtual Processor* clone() const override {
    FilterProcessor* newModule = new FilterProcessor(*this);
...
protected:
  ...
  JUCE_LEAK_DETECTOR(FilterProcessor)
};
} // namespace vital
