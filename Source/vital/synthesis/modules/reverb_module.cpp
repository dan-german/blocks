...
void ReverbModule::init() {
  ...
  Output* reverb_decay_time = createMonoModControl2({ .name = "time", .min = -6.0, .max = 6.0, .value_scale = ValueScale::kExponential });
  ...
  Output* reverb_size = createMonoModControl2({ .name = "size", .min = 0.0, .max = 1.0 });
